...
import (
	...
	"solution1/session-5-validator/test/mock/service"
...
func TestUpdateUserHandler(t *testing.T) {
	...
	t.Run("Negative Test Case - name is empty", func(t *testing.T) {
		...
		invalidUser := entity.User{ID: 1, Name: "", Email: "updated@example.com", Password: "updatedpass"} // User with ID 100 doesn't exist
